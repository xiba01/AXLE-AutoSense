...
export const Subtitles = () => {
    ...
    return (
        <div className="absolute bottom-20 left-0 right-0 z-40 flex justify-center pointer-events-none px-4">
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className="bg-black/70 backdrop-blur-sm px-6 py-3 rounded-full border border-white/10 max-w-2xl"
                >
